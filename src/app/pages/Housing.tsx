        ...
        {markerClickedListing && !directionListing && !isScrolled && (
          <div className="absolute bottom-3 left-3 right-3 sm:right-auto sm:left-4 sm:bottom-4 z-30 w-auto sm:w-[330px] bg-white rounded-3xl shadow-2xl border border-slate-200/90 overflow-hidden animate-in slide-in-from-bottom-3 duration-250 pointer-events-auto">
            ...
            <div className="relative w-full h-28 sm:h-32 overflow-hidden bg-slate-100">
              ...
              <div className="absolute top-2 left-2 px-2.5 py-0.5 rounded-full bg-white/95 backdrop-blur-md text-slate-900 text-[10px] font-bold border border-slate-200/60 flex items-center gap-1 shadow-xs">
                <Building className="w-3 h-3 text-[#C04A22]" />
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative w-full h-32 sm:h-36 overflow-hidden bg-slate-100">
                        ...
                        <div className="absolute top-3 left-3 px-2.5 py-1 rounded-full bg-white/95 backdrop-blur-md text-slate-900 text-xs font-bold border border-slate-200/80 flex items-center gap-1.5 shadow-xs">
                          <Building className="w-3.5 h-3.5 text-[#C04A22]" />
                      ...
                      <div className="p-4 sm:p-5">
                        ...
                        {/* Bottom Bar: Price Pill & Action Buttons */}
                        <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between gap-3">
                          <div className="px-3.5 py-1.5 rounded-xl bg-orange-50/80 text-[#C04A22] text-sm sm:text-base font-black border border-orange-100/60 shadow-2xs">
                            {listing.price}
                          </div>
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className="px-3 py-1.5 rounded-xl bg-[#C04A22]/10 hover:bg-[#C04A22]/20 text-[#8C3015] border border-[#C04A22]/25 text-xs font-bold transition flex items-center gap-1.5 cursor-pointer shadow-2xs hover:shadow-xs active:scale-98"
                            ...
                            <button
                              ...
                              className="px-4 py-1.5 rounded-xl bg-[#C04A22] hover:bg-[#8C3015] text-white text-xs font-bold transition flex items-center gap-1 shadow-xs hover:shadow-md cursor-pointer active:scale-98"
                            >
                              <span>Details</span>
