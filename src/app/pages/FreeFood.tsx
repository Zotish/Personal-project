  ...
  return (
    <AppLayout>
      <div className="min-h-screen bg-[#FDFBF9] pb-16">
        ...
        <div id="food-map-section" className={`w-full max-w-7xl mx-auto px-2 sm:px-4 transition-all duration-300 relative z-20 ${
          isScrolled ? "sticky top-[86px] sm:top-[90px] md:top-[90px] lg:top-[90px] pt-0 bg-[#FDFBF9]" : "pt-2 sm:pt-3"
        }`}>
