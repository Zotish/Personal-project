  ...
  return (
    <AppLayout>
      <div className="w-full h-[calc(100dvh-4rem)] lg:h-[calc(100vh)] flex flex-col overflow-hidden bg-[#FDFBF9]">
        ...
        {/* ── MAIN FOOD DIRECTORY CONTENT (UPORE / ON TOP - PAUSES RIGHT BELOW COMPACT MAP) ── */}
        <div className="flex-1 min-h-[145px] flex flex-col max-w-7xl w-full mx-auto px-0 sm:px-6 relative z-20 bg-[#FDFBF9] rounded-t-3xl shadow-[0_-6px_25px_rgba(0,0,0,0.06)] border-t border-slate-200/80 -mt-2 sm:-mt-3 overflow-hidden">
          {/* ── PINNED BOTTOM SHEET HEADER: Handle bar + Filter Options (NEVER HIDES!) ── */}
          <div className="flex-shrink-0 bg-[#FDFBF9] rounded-t-3xl pt-2 sm:pt-3 select-none border-b border-slate-200/40">
