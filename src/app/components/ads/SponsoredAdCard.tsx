    ...
    <article className="bg-gradient-to-b from-amber-50/20 via-white to-white rounded-2xl border border-amber-200/80 hover:border-amber-300 shadow-2xs hover:shadow-sm transition-all duration-200 overflow-hidden relative group">
      ...
      <div className="px-4 pt-3 pb-1 flex items-center justify-between border-b border-amber-100/60 bg-amber-50/40">
        <div className="flex items-center gap-1.5 text-[11px] font-bold text-amber-800">
          ...
          <span className="text-[10px] text-slate-500 font-normal">Promoted partner for newcomers</span>
        </div>
      ...
      {showInfo && (
        <div className="bg-amber-50 px-4 py-2 text-[11px] text-amber-900 border-b border-amber-200/80 flex items-center justify-between animate-in fade-in duration-150">
          <span>This verified partner provides essential services for immigrants and diaspora members.</span>
          <button onClick={() => setShowInfo(false)} className="text-amber-700 hover:text-amber-900 ml-2">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            type="button"
            onClick={handleAction}
            className="px-3.5 py-1.5 rounded-full bg-slate-900 hover:bg-[#C04A22] text-white text-xs font-bold transition flex items-center gap-1 shadow-xs cursor-pointer active:scale-95 flex-shrink-0"
          >
            <span>{ad.ctaText}</span>
